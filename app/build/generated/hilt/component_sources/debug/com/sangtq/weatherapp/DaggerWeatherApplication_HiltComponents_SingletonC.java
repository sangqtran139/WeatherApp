...
public final class DaggerWeatherApplication_HiltComponents_SingletonC {
  ...
  public static WeatherApplication_HiltComponents.SingletonC create() {
  ...
  private static final class ViewModelCImpl extends WeatherApplication_HiltComponents.ViewModelC {
    ...
    private ForecastWeatherUseCase forecastWeatherUseCase() {
      return new ForecastWeatherUseCase(singletonCImpl.forecastWeatherRepositoryImpl());
    }
  ...
  private static final class SingletonCImpl extends WeatherApplication_HiltComponents.SingletonC {
    ...
    private ForecastWeatherRepositoryImpl forecastWeatherRepositoryImpl() {
      return new ForecastWeatherRepositoryImpl(provideApiServiceProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize() {
      this.provideHttpClientProvider = DoubleCheck.provider(new SwitchingProvider<OkHttpClient>(singletonCImpl, 1));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.sangtq.network.ApiService 
          return (T) DataModule_ProvideApiServiceFactory.provideApiService(DataModule_ProvideGsonConverterFactoryFactory.provideGsonConverterFactory(), singletonCImpl.provideHttpClientProvider.get());

          case 1: // okhttp3.OkHttpClient 
          return (T) DataModule_ProvideHttpClientFactory.provideHttpClient();
